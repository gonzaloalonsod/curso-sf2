...
namespace Proxies\__CG__\Ipap\Bundle\FacturacionBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Pais extends \Ipap\Bundle\FacturacionBundle\Entity\Pais implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ipap\\Bundle\\FacturacionBundle\\Entity\\Pais' . "\0" . 'id', '' . "\0" . 'Ipap\\Bundle\\FacturacionBundle\\Entity\\Pais' . "\0" . 'nombre', '' . "\0" . 'Ipap\\Bundle\\FacturacionBundle\\Entity\\Pais' . "\0" . 'descripcion');
        }
