...
use Ipap\Bundle\FacturacionBundle\Entity\Provincia;
use Ipap\Bundle\FacturacionBundle\Form\ProvinciaType;
...
class ProvinciaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IpapFacturacionBundle:Provincia')->findAll();
     ...
     * @Method("POST")
     * @Template("IpapFacturacionBundle:Provincia:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IpapFacturacionBundle:Provincia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IpapFacturacionBundle:Provincia:edit.html.twig")
     */
